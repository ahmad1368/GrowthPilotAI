...
import 'package:growth_pilot_ai/features/analytics/widgets/banking_gateway_report_widget.dart';
...
import 'package:growth_pilot_ai/features/analytics/widgets/emergency_broadcast_report_widget.dart';
...
import 'package:growth_pilot_ai/features/analytics/widgets/leaderboard_report_widget.dart';
...
import 'package:growth_pilot_ai/features/analytics/widgets/scheduled_task_report_widget.dart';
...
class ReportWidgetsBootstrap {
  static void register() {
    ...
    ReportWidgetRegistry.register(
        ...
        (spec) =>
            LeaderboardReportWidget(data: spec.data, title: spec.title));
    ReportWidgetRegistry.register(
        'AD_CAMPAIGN_CONSTRAINT_ENGINE',
        (spec) =>
            AdConstraintReportWidget(data: spec.data, title: spec.title));
    ReportWidgetRegistry.register(
    ...
    ReportWidgetRegistry.register(
        ...
        (spec) =>
            InventoryRecommendationReportWidget(data: spec.data, title: spec.title));
    ReportWidgetRegistry.register(
    ...
    ReportWidgetRegistry.register(
        ...
        (spec) =>
            TieredCommissionReportWidget(data: spec.data, title: spec.title));
    ReportWidgetRegistry.register(
        'SETTLEMENT_TRACKING_DASHBOARD',
        (spec) =>
            SettlementTrackingReportWidget(data: spec.data, title: spec.title));
    ReportWidgetRegistry.register(
    ...
    ReportWidgetRegistry.register(
        ...
        (spec) =>
            ContactSyncReportWidget(data: spec.data, title: spec.title));
    ReportWidgetRegistry.register(
    ...
    ReportWidgetRegistry.register(
        'BULK_PRODUCT_IMPORT',
        (spec) =>
            BulkImportReportWidget(data: spec.data, title: spec.title));
    ReportWidgetRegistry.register(
