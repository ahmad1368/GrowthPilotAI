...
/// Renders the search box, add button, filtered profile rows, and a
/// summary narrative (Issue #338). Purely presentational — the profile
/// list and search state are owned by [MerchantConfigBody].
    ...
    return Column(
      ...
      children: [
        ...
        for (final config in filteredResults)
          MerchantConfigRow(config: config, onTap: () => onEditProfile(config)),
        const SizedBox(height: 8),
