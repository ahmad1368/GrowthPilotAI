...
import 'package:growth_pilot_ai/features/inbox/widgets/read_receipt_icon.dart';
...
/// and a [ReadReceiptIcon] (Issue #78).
    ...
    return ListTile(
      ...
      trailing: Column(
        ...
        children: [
          ...
          ReadReceiptIcon(isRead: summary.isLatestMessageRead),
        ],
      ),
    );
  }
