...
/// #220) — `webview_flutter` has no Web-platform implementation bundled
/// here, so on Web this shows a flat fallback instead of failing to
/// compile/render (architecture rule: guard native-only packages with
/// `kIsWeb`).
