...
/// criterion 2; regional rates added for Issue #422) — these mirror
/// each provider's typical public rate card, not a live-negotiated
/// merchant rate, since there's no real account behind any of them.
