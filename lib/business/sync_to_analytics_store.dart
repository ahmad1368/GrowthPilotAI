...
/// Also flags out-of-service-area records (#98 "Geographic Sanitization")
/// so the ETL pipeline quarantines them rather than dropping them
/// silently. Pure: the caller persists the result via
...
class SyncToAnalyticsStore {
  static AnonymizedListingEntity call({
    ...
    return AnonymizedListingEntity(
      ...
      isAnomaly: !IsInServiceArea.call(location.lat, location.lng),
    );
  }
}
