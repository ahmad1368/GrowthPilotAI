...
/// Marks a PENDING Smart Recommendation ACTION_CARD SNOOZED in place (Issue
/// #75 "Snooze"). No-op, returning false, once the card is no longer
/// PENDING — mirrors [DismissRecommendation].
class SnoozeRecommendation {
  static bool call(MessageEntity message) {
    ...
    message.dbActionCardStatus = ActionCardStatus.snoozed.index;
    return true;
  }
}
