...
class TransactionController extends GetxController {
  ...
  void _seedTestData() {
    final objectBoxInstance = Get.find<ObjectBox>();
    final transactionBox = objectBoxInstance.store.box<TransactionEntity>();
    ...
    if (transactionBox.isEmpty()) {
      ...
      final catMarketing = CategoryEntity(
          name: "Marketing", icon: "campaign", color: 0xFFFF9800);
      final catUtilities =
      ...
      final catEquipment = CategoryEntity(
          name: "Equipment", icon: "devices", color: 0xFF607D8B);
      ...
      final vNorthwind = VendorEntity(
          name: "Northwind Traders Inc.", taxId: "111222333RT0001");
