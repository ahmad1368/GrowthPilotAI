...
/// `TraceabilityCoverageMixin`). [isSharingAll] guards against
/// duplicate taps and surfaces failures via [RunGuardedExport] (Issue
/// #254).
mixin TraceabilityMultiShareMixin on GetxController {
  ...
  final isSharingAll = false.obs;

  Future<void> shareAllExports() =>
      RunGuardedExport.call(isSharingAll, 'combined XLSX+CSV', 'TraceabilityMultiShareMixin', () async {
