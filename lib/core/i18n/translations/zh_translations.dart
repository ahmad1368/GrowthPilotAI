...
const Map<String, String> zhTranslations = {
  ...
  'nav_profile': '我的',
  'nav_marketplace': '市场',
  'appbar_growth_metrics_tooltip': '增长指标',
  'drawer_dashboard': '仪表盘',
  'drawer_profile': '个人资料',
  'profile_screen_title': '个人资料',
  'profile_name_label': '显示名称',
  'profile_birthdate_label': '出生日期',
  'profile_business_category_label': '行业类别',
  'profile_business_subcategory_label': '子类别',
